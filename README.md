...
[`docs/ec-561-truck-rest.md`](docs/ec-561-truck-rest.md); IMU mount calibration (deferred) in
...
| [`docs/ec-561-truck-rest.md`](docs/ec-561-truck-rest.md) | Truck EC 561/2006: enforced vs tracked vs deferred |
