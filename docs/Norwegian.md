...
bygg: **v0.3.0-alpha** (`versionName` 0.3.0, `versionCode` 3). Last ned fra
[`v0.3.0-alpha`-taggen](https://github.com/Supermagnum/Navi/tree/v0.3.0-alpha)
eller siste kopi på
...
| Fil | Rolle |
|---|---|
| [`compiled/navi-release.apk`](../compiled/navi-release.apk) | **Installer denne** — signert release-APK (arm64, `versionName` 0.3.0 / tag **v0.3.0-alpha**) |
