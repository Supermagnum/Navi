...
bygg: **v0.3.2-beta** (`versionName` 0.3.2-beta, `versionCode` 7). Last ned fra
[`v0.3.2-beta`-taggen](https://github.com/Supermagnum/Navi/tree/v0.3.2-beta)
eller siste kopi på
...
| Fil | Rolle |
|---|---|
| [`compiled/navi-release.apk`](../compiled/navi-release.apk) | **Installer denne** — signert release-APK (arm64, `versionName` 0.3.2-beta / tag **v0.3.2-beta**) |
