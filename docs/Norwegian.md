...
bygg: **v0.3.3-beta** (`versionName` 0.3.3-beta, `versionCode` 8). Last ned fra
[`v0.3.3-beta`-taggen](https://github.com/Supermagnum/Navi/tree/v0.3.3-beta)
eller siste kopi på
...
| Fil | Rolle |
|---|---|
| [`compiled/navi-release.apk`](../compiled/navi-release.apk) | **Installer denne** — signert release-APK (arm64, `versionName` 0.3.3-beta / tag **v0.3.3-beta**) |
