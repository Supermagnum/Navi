...
pub use rest::{
    ...
    plan_motor_multi_day, plan_soft_rest_pauses, plan_truck_multi_day,
    resolve_driving_hours_pack_at, soft_break_distances_km, soft_break_interval_km_fallback,
    soft_car_break_interval_hours, truck_break_distances_km, truck_break_duration_minutes,
    ...
    MotorOvernightCandidate, MotorOvernightKind, MotorOvernightStop, SoftRestCandidate,
    TruckDaySegment, TruckDutyEvaluation, TruckMultiDayPlan, TruckOvernightKind,
    TruckOvernightRest, TruckRestCandidate, TruckRestFacility, OVERNIGHT_NEAR_HUT_MAX_M,
};
pub use safety::{
