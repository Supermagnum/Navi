...
pub use surface_quality::{
    ...
    classify_surface_tags, edge_has_posted_maxspeed, edge_highway_class_multiplier,
    edge_maxspeed_multiplier, edge_motor_soft_multiplier, edge_rough_surface_speed_factor,
    edge_surface_multiplier, infer_surface_from_highway, surface_transition_cost_m,
    worst_incident_surface, MotorSoftCostProfile, SurfaceQuality, SurfaceRoutingMode,
    HIGHWAY_CLASS_SECONDARY, MAXSPEED_MISSING_CAR, MAXSPEED_MISSING_TRUCK,
    ...
    SURFACE_TRANSITION_MAX_CLASS_DROP, SURFACE_TRANSITION_PENALTY_M, SURFACE_UNKNOWN_EDGE_PENALTY,
};
