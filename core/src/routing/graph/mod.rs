...
pub use surface_quality::{
    ...
    infer_surface_from_highway, surface_transition_cost_m, worst_incident_surface,
    MotorSoftCostProfile, SurfaceQuality, SurfaceRoutingMode, MAXSPEED_MISSING_CAR,
    MAXSPEED_MISSING_TRUCK, SNAP_VIRTUAL_APPROACH_SURFACE, SURFACE_MARGINAL_EDGE_PENALTY,
    SURFACE_MARGINAL_MOBILE_HOME, SURFACE_MARGINAL_MOTORCYCLE, SURFACE_MARGINAL_TRUCK,
    SURFACE_POOR_EDGE_PENALTY, SURFACE_POOR_MOBILE_HOME, SURFACE_POOR_MOTORCYCLE,
    SURFACE_POOR_TRUCK, SURFACE_TRANSITION_MAX_CLASS_DROP, SURFACE_TRANSITION_PENALTY_M,
};
